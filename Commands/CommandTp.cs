            ...
            switch (args.Length)
            {
                ...
                */
                case 1:
                {
                    ...
                    context.User.SendLocalizedMessage(Translations, "TELEPORTED", dataName);
                    break;
                }
                ...
                */
                case 2:
                {
                    ...
                    context.User.SendLocalizedMessage(Translations, "TELEPORTED_SENDER", target, dataName);
                    break;
                }
                ...
                */
                case 3:
                {
                    ...
                    if (location.HasValue)
                    {
                        ...
                        context.User.SendLocalizedMessage(Translations, "TELEPORTED", location);
                    }
                    else
                    {
                ...
                */
                case 4:
                {
                    ...
                    if (location.HasValue)
                    {
                        ...
                        context.User.SendLocalizedMessage(Translations, "TELEPORTED_SENDER", target, location);
                    }
                    else
                    {
